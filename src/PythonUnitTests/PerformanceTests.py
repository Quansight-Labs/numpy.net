...
class PerformanceTests(unittest.TestCase):
    ...
    def test_AddReduce_Performance_DOUBLE   (self):
        ...
        a = np.arange(0, 4000 * 10 * 4000, dtype=np.float64);
    ...
    def test_AddReduce_Performance_UINT32(self):
        ...
        a = np.arange(10000000, dtype=np.uint32);
    ...
    def test_Performance_var_INT32(self):
    ...
    def test_Performance_Prod2_UINT64(self):
