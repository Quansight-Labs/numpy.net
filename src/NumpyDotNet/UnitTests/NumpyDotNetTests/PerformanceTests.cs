    ...
    #region DOUBLE tests
      ...
      //  [Ignore]
        ...
        public void Performance_AddOuter_DOUBLE()
        {
            ...
            for (int i = 0; i < LoopCount; i++)
            {
               b = np.ufunc.outer(UFuncOperation.add, np.Float64, a, a);
            }
            var c = np.sum(b);
            ...
            var img = np.array(new float[] 
                { 208.0f, 54.0f, 1.0f,
                  ...
                  221.0f, 53.0f, 5.0f,
                    ...
                    255.0f, 255.0f, 238.0f,
                    255.0f, 255.0f, 242.0f,
                    255.0f, 254.0f, 252.0f,
                    255.0f, 254.0f, 255.0f,

                    250.0f, 255.0f, 252.0f,
                    250.0f, 255.0f, 252.0f,
                    253.0f, 255.0f, 252.0f,
                    253.0f, 255.0f, 252.0f,
                    253.0f, 255.0f, 251.0f,
                    251.0f, 255.0f, 249.0f,
                    248.0f, 255.0f, 249.0f,
                    250.0f, 255.0f, 251.0f,
                    255.0f, 254.0f, 255.0f,
